...
- when the supernova was embedded in a bright galaxy, the latter was subtracted using previously or subsequently taken data (galaxy_subtraction/). Whether or not this was necessary was determined by looking at the SNR as a function of distance from the bulge [SNR_mega.py].
