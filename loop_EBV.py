...
PARAMETERS = ['zcmb', 'DM', 'DM_err', 'st', 'st_err', 'Tmax', 'Tmax_err', ''i_max', 'i_max_error', 'r_max', 'r_max_error','v_max', 'v_max_error' ]
...
SN_list = ['2025acsn', '2019np', '2020ue', '2025aebt', '2025afwg', '2025ahkt',
...
for idx, file in enumerate(the_list):
    try:
        ...
        all_results[s.name] = {
            'zcmb'    : zcmb,
            'imax'      : s.parameters.get('imax',    None),
            'imax_err'  : s.errors.get('imax',        None),
            'rmax'      : s.parameters.get('rmax',    None),
            'rmax_err'  : s.errors.get('rmax',        None),
            'vmax'      : s.parameters.get('Vmax',    None),
            'vmax_err'  : s.errors.get('Vmax',        None),
            'st'    : s.parameters.get('st',   None),
            'st_err': s.errors.get('st',       None),
